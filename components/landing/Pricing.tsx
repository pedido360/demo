...
const whatsappUrl =
    "https://wa.me/TUNUMERO?text=Hola%20👋%0A%0AQuiero%20iniciar%20con%20Pedidos360%20para%20mi%20restaurante.%0A%0AMe%20gustaría%20coordinar%20la%20contratación%20del%20servicio%20y%20comenzar%20la%20personalización%20de%20mi%20menú%20digital.%0A%0AQuedo%20atento%20para%20iniciar%20el%20proceso.";
                ...
                <div className="mx-auto max-w-7xl px-6">
                        ...
                        <div className="grid lg:grid-cols-2">
                            ...
                            <div className="p-10 lg:p-14">
                                ...
                                <h2 className="mt-6 text-4xl font-extrabold leading-tight text-gray-900 md:text-5xl">
                                    Hoy empieza la transformación digital de tu restaurante.
                                </h2>

                                <p className="mt-6 text-lg leading-8 text-gray-600">
                                    Ya conoces cómo funciona Pedidos360.
                                    Ahora solo queda un paso:
                                    coordinar la implementación de tu restaurante
                                    para que muy pronto estés recibiendo pedidos
                            ...
                            <div className="flex flex-col justify-center bg-gray-900 p-10 text-white lg:p-14">
                                ...
                                <h3 className="mt-5 text-4xl font-bold">
                                    Quiero mi Pedidos360.
                                </h3>

                                <p className="mt-6 text-lg leading-8 text-gray-300">
                                    Después de hacer clic coordinaremos contigo la
                                    contratación del servicio, la personalización
                                    de tu restaurante y la puesta en marcha de tu
                                    menú digital.
                                </p>
                                ...
                                <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-5">
                                    ...
                                    <ul className="mt-4 space-y-3 text-sm text-gray-300">
                                        ...
                                        <li>✅ Coordinaremos la contratación.</li>

                                        <li>✅ Personalizaremos tu restaurante.</li>

                                        <li>✅ Configuraremos tu menú digital.</li>
                    ...
                    <div className="mt-20 text-center">
                        ...
                        <p className="mt-4 text-lg text-orange-100">
                            Bienvenido a <span className="font-bold">Pedidos360.</span>
                        </p>
